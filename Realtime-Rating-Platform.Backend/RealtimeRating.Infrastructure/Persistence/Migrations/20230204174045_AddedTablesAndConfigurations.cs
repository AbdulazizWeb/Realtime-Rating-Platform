        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentRooms_StudentGroups_StudentGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    StudentRoomId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonTasks_StudentRooms_StudentRoomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_LessonTasks_LessonTaskId",
                        column: x => x.LessonTaskId,
                        principalTable: "LessonTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratings_StudentGroups_StudentGroupId",
                        column: x => x.StudentGroupId,
                        principalTable: "StudentGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "baxtiyorov1999@bk.ru", "Abdulaziz Baxtiyorov", "CA5B9811BE39C13BA3F8265C006761214B85F36FFE177C482AA548A30FC2C8994F5AE33790A4AE6A302B65A05A906AAED4912F02C0E69FC6CE14A9C90AD998A0", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonTasks_StudentRoomId",
                table: "LessonTasks",
                column: "StudentRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_LessonTaskId",
                table: "Ratings",
                column: "LessonTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_StudentGroupId",
                table: "Ratings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentRooms_StudentGroupId",
                table: "StudentRooms",
                column: "StudentGroupId");
